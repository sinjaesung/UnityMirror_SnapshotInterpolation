...
public class ClientCube : MonoBehaviour
{
    ...
    public void OnMessage(Snapshot3D snap)
    {
        ...
        if (snapshotSettings.dynamicAdjustment)
        {
            ...
            Debug.Log("ClientCube OnMessage dynamicAdjustment>>");
        ...
        Debug.Log("ClientCube OnMessage InsertAndAdjust>>");
    ...
    void Update()
    {
        ...
        if (snapshots.Count > 0)
        {
            ...
            if (interpolate)
            {
                ...
                Debug.Log("ClientCube SnapshotInterpolation.Step");
                // interpolate & apply
        ...
        if (localTimescale < 1)
        {
            Debug.Log("ClientCube localTimescale < 1" + localTimescale);
        ...
        {
            Debug.Log("ClientCube localTimescale else" + localTimescale);
    ...
    void OnValidate()
    {
        Debug.Log("ClientCube OnValidate>>");
